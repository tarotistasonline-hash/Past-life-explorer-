...
export interface TranslationDictionary {
  ...
  voiceStyleTitle: string;
  voiceStyleUltratumba: string;
  voiceStyleUltratumbaDesc: string;
  voiceStyleSolemn: string;
  voiceStyleSolemnDesc: string;
  voiceStyleSpectral: string;
  voiceStyleSpectralDesc: string;
  voiceStyleAncient: string;
  voiceStyleAncientDesc: string;
  voicePitchLabel: string;
  voiceRateLabel: string;
  voiceCavernReverbLabel: string;
  voiceCavernReverbDesc: string;
  voiceSampleUltratumbaText: string;
  ...
  pastLifeModalShareBtn: string;
  pastLifeModalShareImageTitle: string;
  pastLifeModalExportImage: string;
  pastLifeModalGeneratingImage: string;
  pastLifeModalNativeShare: string;
  pastLifeModalDownloadImage: string;
  pastLifeModalCopyImage: string;
  pastLifeModalImageCopied: string;
  pastLifeModalShareTip: string;
...
export const TRANSLATIONS: Record<SupportedLanguage, TranslationDictionary> = {
  es: {
    ...
    voiceModalTitle: "Voz Espiritual & Resonancia de Ultratumba",
    voiceModalDesc: "Modula la frecuencia vocal del oráculo entre un tono solemne de registro akáshico o una presencia cavernosa y sepulcral del más allá.",
    voiceStyleTitle: "Estilo y Timbre Espiritual",
    voiceStyleUltratumba: "⚰️ Voz de Ultratumba (Cavernosa)",
    voiceStyleUltratumbaDesc: "Tono sepulcral, ultra profundo y cadencia fantasmal del más allá con resonancia espectral",
    voiceStyleSolemn: "🔮 Oráculo Akáshico (Solemne)",
    voiceStyleSolemnDesc: "Tono sagrado, equilibrado y ceremonial de los guardianes del registro",
    voiceStyleSpectral: "🕯️ Susurro del Más Allá (Enigmático)",
    voiceStyleSpectralDesc: "Eco fantasmal de baja frecuencia, místico y susurrante",
    voiceStyleAncient: "📜 Anciano de los Registros (Grave)",
    voiceStyleAncientDesc: "Cadencia pesada, lenta y milenaria del plano ancestral",
    voicePitchLabel: "Tono Vocal (Gravedad Espectral)",
    voiceRateLabel: "Cadencia / Velocidad de Narración",
    voiceCavernReverbLabel: "Resonancia Cavernosa de Ultratumba",
    voiceCavernReverbDesc: "Genera un aura sutil de subgraves y viento espectral mientras habla el espíritu",
    voiceSampleUltratumbaText: "Hablo desde el umbral de ultratumba... El velo se ha rasgado y los ecos de tu alma vuelven a la luz.",
    testVoiceTitle: "Probar Voz Espiritual",
    testVoiceDesc: "Escucha una muestra con el estilo, tono y resonancia configurados",
    playSample: "Escuchar Muestra",
    playingSample: "Reproduciendo...",
    availableVoices: "Voces Masculinas Disponibles en tu Dispositivo",
    autoVoiceOptimal: "✨ Selección Automática Óptima (Hombre Solemne / Ultratumba)",
    ...
    welcomeWarning: "Formula tus preguntas con respeto e introspección. Cada respuesta deletreada por la tabla ouija porta una lección para tu momento presente.",
    ...
    pastLifeModalShareBtn: "Compartir",
    pastLifeModalShareImageTitle: "Compartir Revelación en Redes Sociales",
    pastLifeModalExportImage: "Exportar Imagen",
    pastLifeModalGeneratingImage: "Generando imagen mágica...",
    pastLifeModalNativeShare: "Compartir en Redes",
    pastLifeModalDownloadImage: "Descargar Imagen PNG",
    pastLifeModalCopyImage: "Copiar Imagen",
    pastLifeModalImageCopied: "¡Imagen copiada al portapapeles!",
    pastLifeModalShareTip: "Ideal para compartir en historias de Instagram, estados de WhatsApp, X y Facebook.",
  ...
  en: {
    ...
    voiceModalTitle: "Spiritual Voice & Netherworld Resonance",
    voiceModalDesc: "Modulate the oracle's vocal frequency between solemn Akashic guidance or a cavernous, ghostly voice from beyond the grave.",
    voiceStyleTitle: "Spiritual Voice Timbre",
    voiceStyleUltratumba: "⚰️ Beyond the Grave (Cavernous)",
    voiceStyleUltratumbaDesc: "Sepulchral, ultra-deep tone with ghostly afterlife cadence and spectral resonance",
    voiceStyleSolemn: "🔮 Akashic Oracle (Solemn)",
    voiceStyleSolemnDesc: "Sacred, balanced, ceremonial tone of the record guardians",
    voiceStyleSpectral: "🕯️ Netherworld Whisper (Enigmatic)",
    voiceStyleSpectralDesc: "Low-frequency ethereal, whispering ghost resonance",
    voiceStyleAncient: "📜 Ancient Record Keeper (Deep)",
    voiceStyleAncientDesc: "Millennial, heavy, and deliberate ancient cadence",
    voicePitchLabel: "Vocal Pitch (Spectral Depth)",
    voiceRateLabel: "Narration Pace / Speed",
    voiceCavernReverbLabel: "Cavernous Afterlife Resonance",
    voiceCavernReverbDesc: "Weaves an ethereal sub-bass aura and spectral wind while the spirit speaks",
    voiceSampleUltratumbaText: "I speak from beyond the veil of death... The shroud is torn, and echoes of your soul awaken.",
    testVoiceTitle: "Test Spiritual Voice",
    testVoiceDesc: "Listen to a sample with the configured style, pitch, and resonance",
    playSample: "Listen to Sample",
    playingSample: "Playing...",
    availableVoices: "Available Male Voices on Your Device",
    autoVoiceOptimal: "✨ Optimal Automatic Selection (Solemn / Netherworld Male)",
    ...
    welcomeListenVoice: "⚰️ Hear Voice from Beyond",
    welcomeStopVoice: "Stop Voice",
    welcomeVoiceText: "I speak from beyond the veil of death... The shroud of time is torn. Welcome to the Akashic Records and Past Lives sanctuary. Discover who you were in your past incarnations and the ancient wisdom of your soul through the channeling of the Ouija board.",
    ...
    pastLifeModalShareBtn: "Share",
    pastLifeModalShareImageTitle: "Share Past Life Revelation on Social Media",
    pastLifeModalExportImage: "Export Image",
    pastLifeModalGeneratingImage: "Generating mystical image...",
    pastLifeModalNativeShare: "Share to Social Media",
    pastLifeModalDownloadImage: "Download Image PNG",
    pastLifeModalCopyImage: "Copy Image",
    pastLifeModalImageCopied: "Image copied to clipboard!",
    pastLifeModalShareTip: "Ideal for Instagram stories, WhatsApp status, X, and Facebook.",
  ...
  pt: {
    ...
    voiceModalTitle: "Voz Espiritual & Ressonância do Além-Túmulo",
    voiceModalDesc: "Module a frequência vocal do oráculo entre um tom solene akáshico ou uma presença cavernosa do além-túmulo.",
    voiceStyleTitle: "Estilo e Timbre Espiritual",
    voiceStyleUltratumba: "⚰️ Voz do Além-Túmulo (Cavernosa)",
    voiceStyleUltratumbaDesc: "Tom sepulcral, ultra profundo e cadência fantasmagórica do além com ressonância espectral",
    voiceStyleSolemn: "🔮 Oráculo Akáshico (Solene)",
    voiceStyleSolemnDesc: "Tom sagrado, equilibrado e cerimonial dos guardiões",
    voiceStyleSpectral: "🕯️ Sussurro do Além (Enigmático)",
    voiceStyleSpectralDesc: "Eco fantasmagórico de baixa frequência e misterioso",
    voiceStyleAncient: "📜 Ancião dos Registros (Grave)",
    voiceStyleAncientDesc: "Cadência pesada, lenta e milenar do plano ancestral",
    voicePitchLabel: "Tom Vocal (Gravidade Espectral)",
    voiceRateLabel: "Cadência / Velocidade de Narração",
    voiceCavernReverbLabel: "Ressonância Cavernosa do Além",
    voiceCavernReverbDesc: "Gera uma aura sutil de subgraves e vento espectral enquanto a voz fala",
    voiceSampleUltratumbaText: "Falo do limiar do além-túmulo... O véu foi rasgado e os ecos da sua alma despertam.",
    testVoiceTitle: "Testar Voz Espiritual",
    testVoiceDesc: "Ouça uma amostra com o estilo, tom e ressonância configurados",
    playSample: "Ouvir Amostra",
    playingSample: "Reproduzindo...",
    availableVoices: "Vozes Masculinas Disponíveis no Dispositivo",
    autoVoiceOptimal: "✨ Seleção Automática Ideal (Solene / Além-Túmulo)",
    ...
    welcomeListenVoice: "⚰️ Ouvir Voz do Além-Túmulo",
    welcomeStopVoice: "Parar Voz",
    welcomeVoiceText: "Falo do limiar do além-túmulo... O véu dos tempos foi rasgado. Dou-lhe as boas-vindas aos Registos Akáshicos e Vidas Passadas. Descubra quem foi nas suas encarnações anteriores e a sabedoria ancestral da sua alma através da canalização do tabuleiro ouija.",
    welcomeModalTitle: "Registros Akáshicos",
    ...
    pastLifeModalShareBtn: "Compartilhar",
    pastLifeModalShareImageTitle: "Compartilhar Revelação nas Redes Sociais",
    pastLifeModalExportImage: "Exportar Imagem",
    pastLifeModalGeneratingImage: "Gerando imagem mística...",
    pastLifeModalNativeShare: "Compartilhar nas Redes",
    pastLifeModalDownloadImage: "Baixar Imagem PNG",
    pastLifeModalCopyImage: "Copiar Imagem",
    pastLifeModalImageCopied: "Imagem copiada para a área de transferência!",
    pastLifeModalShareTip: "Ideal para compartilhar nos stories do Instagram, status do WhatsApp, X e Facebook.",
  ...
  fr: {
    ...
    voiceModalTitle: "Voix Spirituelle & Résonance d'Outre-Tombe",
    voiceModalDesc: "Modulez la fréquence vocale de l'oracle entre une guidance akashique solennelle ou une présence caverneuse d'outre-tombe.",
    voiceStyleTitle: "Style et Timbre Spirituel",
    voiceStyleUltratumba: "⚰️ Voix d'Outre-Tombe (Caverneuse)",
    voiceStyleUltratumbaDesc: "Ton sépulcral, ultra-profond et cadence fantomatique de l'au-delà avec résonance spectrale",
    voiceStyleSolemn: "🔮 Oracle Akashique (Solennel)",
    voiceStyleSolemnDesc: "Ton sacré, équilibré et cérémonial des gardiens",
    voiceStyleSpectral: "🕯️ Murmure de l'Au-Delà (Énigmatique)",
    voiceStyleSpectralDesc: "Écho spectral de basse fréquence et mystérieux",
    voiceStyleAncient: "📜 Ancien des Mémoires (Grave)",
    voiceStyleAncientDesc: "Cadence millénaire, lente et profonde",
    voicePitchLabel: "Hauteur Vocale (Gravité Spectrale)",
    voiceRateLabel: "Cadence / Vitesse de Narration",
    voiceCavernReverbLabel: "Résonance Caverneuse d'Outre-Tombe",
    voiceCavernReverbDesc: "Tisse une aura subtile de sous-basses et de vent spectral pendant la parole",
    voiceSampleUltratumbaText: "Je parle depuis le seuil d'outre-tombe... Le voile est déchiré et les échos de ton âme s'éveillent.",
    testVoiceTitle: "Tester la Voix Spirituelle",
    testVoiceDesc: "Écoutez un extrait avec le style, le ton et la résonance configurés",
    playSample: "Écouter l'Extrait",
    playingSample: "Lecture...",
    availableVoices: "Voix Masculines Disponibles sur votre Appareil",
    autoVoiceOptimal: "✨ Sélection Automatique Optimale (Solennel / Outre-Tombe)",
    ...
    welcomeListenVoice: "⚰️ Écouter la Voix d'Outre-Tombe",
    welcomeStopVoice: "Arrêter la Voix",
    welcomeVoiceText: "Je parle depuis le seuil d'outre-tombe... Le voile des temps est déchiré. Bienvenue aux Annales Akashiques et Vies Antérieures. Découvrez qui vous étiez dans vos incarnations précédentes et la sagesse ancestrale de votre âme grâce à la canalisation de la table ouija.",
    ...
    pastLifeModalShareBtn: "Partager",
    pastLifeModalShareImageTitle: "Partager la Révélation sur les Réseaux Sociaux",
    pastLifeModalExportImage: "Exporter l'Image",
    pastLifeModalGeneratingImage: "Génération de l'image mystique...",
    pastLifeModalNativeShare: "Partager sur les Réseaux",
    pastLifeModalDownloadImage: "Télécharger l'Image PNG",
    pastLifeModalCopyImage: "Copier l'Image",
    pastLifeModalImageCopied: "Image copiée dans le presse-papiers !",
    pastLifeModalShareTip: "Idéal pour les stories Instagram, statuts WhatsApp, X et Facebook.",
  ...
  it: {
    ...
    voiceModalTitle: "Voce Spirituale & Risonanza dell'Oltretomba",
    voiceModalDesc: "Modula la frequenza vocale dell'oracolo tra una guida akashica solenne o una presenza cavernosa dell'oltretomba.",
    voiceStyleTitle: "Stile e Timbro Spirituale",
    voiceStyleUltratumba: "⚰️ Voce dell'Oltretomba (Cavernosa)",
    voiceStyleUltratumbaDesc: "Tono sepolcrale, ultra profondo e cadenza spettrale dell'aldilà con risonanza",
    voiceStyleSolemn: "🔮 Oracolo Akashico (Solenne)",
    voiceStyleSolemnDesc: "Tono sacro, equilibrato e cerimoniale dei guardiani",
    voiceStyleSpectral: "🕯️ Sussurro dell'Aldilà (Enigmatico)",
    voiceStyleSpectralDesc: "Eco spettrale a bassa frequenza e misterioso",
    voiceStyleAncient: "📜 Antico dei Registri (Grave)",
    voiceStyleAncientDesc: "Cadenza millenaria, lenta e pesante del piano ancestrale",
    voicePitchLabel: "Tono Vocale (Profondità Spettrale)",
    voiceRateLabel: "Cadenza / Velocità di Narrazione",
    voiceCavernReverbLabel: "Risonanza Cavernosa dell'Oltretomba",
    voiceCavernReverbDesc: "Genera un'aura di sub-bassi e vento spettrale mentre parla lo spirito",
    voiceSampleUltratumbaText: "Parlo dalla soglia dell'oltretomba... Il velo è strappato e gli echi della tua anima si risvegliano.",
    testVoiceTitle: "Prova Voce Spirituale",
    testVoiceDesc: "Ascolta un campione con lo stile, il tono e la risonanza configurati",
    playSample: "Ascolta Campione",
    playingSample: "In riproduzione...",
    availableVoices: "Voci Maschili Disponibili sul tuo Dispositivo",
    autoVoiceOptimal: "✨ Selezione Automatica Ottimale (Solenne / Oltretomba)",
    ...
    welcomeListenVoice: "⚰️ Ascolta la Voce dell'Oltretomba",
    welcomeStopVoice: "Ferma Voce",
    welcomeVoiceText: "Parlo dalla soglia dell'oltretomba... Il velo dei tempi è squarciato. Ti do il benvenuto ai Registri Akashici e alle Vite Passate. Scopri chi eri nelle tue incarnazioni passate e la saggezza ancestrale della tua anima attraverso la canalizzazione della tavola ouija.",
    ...
    pastLifeModalShareBtn: "Condividi",
    pastLifeModalShareImageTitle: "Condividi Rivelazione sui Social Media",
    pastLifeModalExportImage: "Esporta Immagine",
    pastLifeModalGeneratingImage: "Generazione immagine mistica...",
    pastLifeModalNativeShare: "Condividi sui Social",
    pastLifeModalDownloadImage: "Scarica Immagine PNG",
    pastLifeModalCopyImage: "Copia Immagine",
    pastLifeModalImageCopied: "Immagine copiata negli appunti!",
    pastLifeModalShareTip: "Ideale per storie di Instagram, stati di WhatsApp, X e Facebook.",
  ...
  de: {
    ...
    voiceModalTitle: "Geisterstimme & Grabesresonanz",
    voiceModalDesc: "Moduliere die Vokalfrequenz des Orakels zwischen feierlicher Akasha-Führung oder einer unheimlichen Grabesstimme aus dem Jenseits.",
    voiceStyleTitle: "Spiritueller Stimmklang",
    voiceStyleUltratumba: "⚰️ Grabesstimme (Kavernös)",
    voiceStyleUltratumbaDesc: "Sepulkraler, extrem tiefer Ton mit geisterhafter Jenseitskadenz und Resonanz",
    voiceStyleSolemn: "🔮 Akasha-Orakel (Feierlich)",
    voiceStyleSolemnDesc: "Heiliger, ausgeglichener und zeremonieller Ton der Wächter",
    voiceStyleSpectral: "🕯️ Jenseitsflüstern (Rätselhaft)",
    voiceStyleSpectralDesc: "Niederfrequentes, geheimnisvolles Geisterecho",
    voiceStyleAncient: "📜 Ältester der Chronik (Tief)",
    voiceStyleAncientDesc: "Jahrtausendealte, schwere und gemessene Kadenz",
    voicePitchLabel: "Stimmhöhe (Spektrale Tiefe)",
    voiceRateLabel: "Sprechtempo / Kadenz",
    voiceCavernReverbLabel: "Kavernöse Jenseitsresonanz",
    voiceCavernReverbDesc: "Erzeugt eine ätherische Subbass-Aura und spektralen Wind während des Sprechens",
    voiceSampleUltratumbaText: "Ich spreche von der Schwelle des Jenseits... Der Schleier ist zerrissen und das Echo deiner Seele erwacht.",
    testVoiceTitle: "Spirituelle Stimme Testen",
    testVoiceDesc: "Höre eine Hörprobe mit dem gewählten Stil, Ton und der Resonanz",
    playSample: "Hörprobe Abspielen",
    playingSample: "Wiedergabe...",
    availableVoices: "Verfügbare Stimmen auf deinem Gerät",
    autoVoiceOptimal: "✨ Optimale Automatische Auswahl (Feierlich / Jenseits)",
    ...
    welcomeListenVoice: "⚰️ Grabesstimme Anhören",
    welcomeStopVoice: "Stimme Stoppen",
    welcomeVoiceText: "Ich spreche von der Schwelle des Jenseits... Der Schleier der Zeit ist zerrissen. Willkommen in der Akasha-Chronik und bei den früheren Leben. Erfahre, wer du in deinen früheren Inkarnationen warst und die Weisheit deiner Seele durch das Channeling des Ouija-Bretts.",
    ...
    pastLifeModalShareBtn: "Teilen",
    pastLifeModalShareImageTitle: "Offenbarung in Sozialen Medien Teilen",
    pastLifeModalExportImage: "Bild Exportieren",
    pastLifeModalGeneratingImage: "Mystisches Bild wird erstellt...",
    pastLifeModalNativeShare: "In Sozialen Medien Teilen",
    pastLifeModalDownloadImage: "PNG-Bild Herunterladen",
    pastLifeModalCopyImage: "Bild Kopieren",
    pastLifeModalImageCopied: "Bild in die Zwischenablage kopiert!",
    pastLifeModalShareTip: "Ideal für Instagram Stories, WhatsApp Status, X und Facebook.",
